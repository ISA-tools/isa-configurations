...
All available configurations produced by the ISA tools team and collaborators (http://isatab.sourceforge.net/people_funding.html) can be viewed vin a table at the dedicated ISA-tools Configuration File page (https://github.com/ISA-tools/Configuration-Files/wiki)
